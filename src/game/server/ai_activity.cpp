...
//===========================
	...
	// ANTICITIZEN
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_EMPTY_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRIMARYATTACK_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RECOIL1_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RECOIL2_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RECOIL3_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_DRYFIRE_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_DRAW_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_DRAW_EMPTY_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOAD_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HOLSTER_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_LOWERED_TO_IDLE_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_TO_LOWERED_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_LOWERED_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SECONDARYATTACK_TWO_HANDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIDGET_TWO_HANDED);

	//Survivor!
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_SNIPER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_SHAKETRAP);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_TURRET);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_GATLING);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_MAN_GUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_TRANSIBER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_GATLING02);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_H_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_DRINK);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_STUNGUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_LASER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_PISTOL2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_MANHAC);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_RPG2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_INVISIBLE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_GLOVE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_DEKOI);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_TIMERG);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CHARGEBOW);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_SHAKE_STRONG);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_E_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_SBOX);

	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_SNIPER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_SHAKETRAP);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_TURRET);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_GATLING);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_MAN_GUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_TRANSIBER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_H_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_DRINK);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_STUNGUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_LASER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_PISTOL2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_MANHAC);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_RPG2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_INVISIBLE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_GLOVE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_DEKOI);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_TIMERG);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_CHARGEBOW);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_SHAKE_STRONG);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_RUN_E_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_RUN_SBOX);

	ADD_ACTIVITY_TO_SR(ACT_HL2AC_CROUCH_SNIPER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_CROUCH_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_CROUCH_SHAKETRAP);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_CROUCH_TURRET);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_CROUCH_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_CROUCH_GATLING);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_CROUCH_MAN_GUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_TRANSIBER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_IDLE_CROUCH_H_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_DRINK);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_STUNGUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_CROUCH_LASER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_PISTOL2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_MANHAC);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_RPG2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_INVISIBLE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_GLOVE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_DEKOI);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_TIMERG);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_CHARGEBOW);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_IDLE_CROUCH_SHAKE_STRONG);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_CROUCH_E_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_CROUCH_SBOX);

	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_SNIPER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_SHAKETRAP);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_TURRET);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_GATLING);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_MAN_GUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_TRANSIBER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_H_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_DRINK);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_STUNGUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_LASER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_PISTOL2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_MANHAC);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_RPG2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_INVISIBLE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_GLOVE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_DEKOI);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_TIMERG);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_CHARGEBOW);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_WALK_CROUCH_SHAKE_STRONG);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_E_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_WALK_CROUCH_SBOX);

	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_SNIPER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_SHAKETRAP);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_TURRET);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK01_GATLING);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_H_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_DRINK);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_STUNGUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_LASER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_PISTOL2_R);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_PISTOL2_L);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_MANHAC);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_RPG2_R);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_RPG2_L);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_RPG2_RL);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_INVISIBLE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_GLOVE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_DEKOI);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_TIMERG);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_CHARGEBOW);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RANGE_ATTACK_SHAKE_STRONG);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_E_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RANGE_ATTACK_SBOX);

	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_SNIPER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_SHAKETRAP);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_TURRET);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_GATLING);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_MAN_GUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_KNIFE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_TRANSIBER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_H_SHIELD);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_DRINK);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_STUNGUN);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_LASER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_PISTOL2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_MANHAC);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_RPG2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_INVISIBLE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_GLOVE);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_DEKOI);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_TIMERG);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_CHARGEBOW);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_JUMP_SHAKE_STRONG);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_E_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_JUMP_SBOX);

	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RELOAD_SNIPER);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RELOAD_INJECTION);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RELOAD_DRINK);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RELOAD_LASER);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RELOAD_PISTOL2);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RELOAD_MANHAC);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RELOAD_DEKOI);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_GESTURE_RELOAD_CHARGEBOW);
	ADD_ACTIVITY_TO_SR(ACT_HL2AC_GESTURE_RELOAD_E_INJECTION);
}
