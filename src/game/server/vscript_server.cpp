...
#include "anticitizen/anticitizen_playerclass_info_parse.h"
...
#ifdef HL2_DLL
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_PLASMANODE)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_SPIT)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_HOMING_MISSILE)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_COMBINE_BALL)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_FIRST_NPC)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_HOUNDEYE)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_CROW)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_HEADCRAB)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_STRIDER)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_GUNSHIP)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_ANTLION)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_LAST_NPC)
DECLARE_SCRIPT_CONST(ECollisionGroup, HL2COLLISION_GROUP_COMBINE_BALL_NPC)
DECLARE_SCRIPT_CONST(ECollisionGroup, LAST_HL2_COLLISION_GROUP)
#else
...
//ANTICITIZEN CONSTS HERE
DECLARE_SCRIPT_CONST_TABLE(EAC1Team)
DECLARE_SCRIPT_CONST(EAC1Team, TEAM_COMBINE)
DECLARE_SCRIPT_CONST(EAC1Team, TEAM_FREEMAN)
REGISTER_SCRIPT_CONST_TABLE(EAC1Team)

DECLARE_SCRIPT_CONST_TABLE(EAC1Class)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_INVALID)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_METROPOLICE)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_COMBINE_SOLDIER)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_COMBINE_SHOTGUNNER)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_COMBINE_ELITE)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_COMBINE_ASSASSIN)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_FIRST_COMBINE_CLASS)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_LAST_COMBINE_CLASS)
DECLARE_SCRIPT_CONST(EAC1Class, CLS_FREEMAN)
REGISTER_SCRIPT_CONST_TABLE(EAC1Class)

DECLARE_SCRIPT_CONST_TABLE(EAC1ClassType)
DECLARE_SCRIPT_CONST(EAC1ClassType, CLS_TYPE_NONE)
DECLARE_SCRIPT_CONST(EAC1ClassType, CLS_TYPE_LOW_TIER)
DECLARE_SCRIPT_CONST(EAC1ClassType, CLS_TYPE_MID_TIER)
DECLARE_SCRIPT_CONST(EAC1ClassType, CLS_TYPE_HIGH_TIER)
DECLARE_SCRIPT_CONST(EAC1ClassType, CLS_TYPE_FREEMAN)
REGISTER_SCRIPT_CONST_TABLE(EAC1ClassType)

DECLARE_SCRIPT_CONST_TABLE(EAC1ClassVoiceType)
DECLARE_SCRIPT_CONST(EAC1ClassVoiceType, CLS_TYPE_NONE)
DECLARE_SCRIPT_CONST(EAC1ClassVoiceType, CLS_TYPE_LOW_TIER)
DECLARE_SCRIPT_CONST(EAC1ClassVoiceType, CLS_TYPE_MID_TIER)
REGISTER_SCRIPT_CONST_TABLE(EAC1ClassVoiceType)

DECLARE_SCRIPT_CONST_TABLE(EAC1RoundState)
DECLARE_SCRIPT_CONST(EAC1RoundState, STATE_PREROUND)
DECLARE_SCRIPT_CONST(EAC1RoundState, STATE_PLAYING)
DECLARE_SCRIPT_CONST(EAC1RoundState, STATE_COMPLETION)
REGISTER_SCRIPT_CONST_TABLE(EAC1RoundState)

DECLARE_SCRIPT_CONST_TABLE(EAC1EndReason)
DECLARE_SCRIPT_CONST(EAC1EndReason, GAME_NOT_ENDED)
DECLARE_SCRIPT_CONST(EAC1EndReason, GAME_END_NOTENOUGHPLAYERS)
DECLARE_SCRIPT_CONST(EAC1EndReason, GAME_END_FREEMANDEAD)
DECLARE_SCRIPT_CONST(EAC1EndReason, GAME_END_NOMORESOLDIERS)
REGISTER_SCRIPT_CONST_TABLE(EAC1EndReason)

DECLARE_SCRIPT_CONST_TABLE(EAC1Sentence)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_COMBINE_ANNOUNCE)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_COMBINE_ASSAULT)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_FLANK)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_GO_ALERT)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_LOST_LONG)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_LOST_SHORT)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_REFIND_ENEMY)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_DANGER)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_COMBINE_ALERT)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_IDLE)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_QUEST)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_ANSWER)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_CLEAR)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_CHECK)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_LOST_GROUP)
DECLARE_SCRIPT_CONST(EAC1Sentence, MP_SENTENCE_ALERT_GROUP)
REGISTER_SCRIPT_CONST_TABLE(EAC1Sentence)
