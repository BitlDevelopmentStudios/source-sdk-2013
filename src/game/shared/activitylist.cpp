...
//HL2MP
	...
	// ANTICITIZEN
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_EMPTY_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RECOIL1_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RECOIL2_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RECOIL3_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRYFIRE_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_DRAW_EMPTY_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOAD_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_HOLSTER_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_LOWERED_TO_IDLE_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_TO_LOWERED_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_LOWERED_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SECONDARYATTACK_TWO_HANDED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIDGET_TWO_HANDED);
	
	// Survivor
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_SNIPER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_SHAKETRAP);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_TURRET);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_GATLING);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_MAN_GUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_TRANSIBER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_GATLING02);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_H_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_DRINK);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_STUNGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_LASER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_PISTOL2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_MANHAC);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_RPG2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_INVISIBLE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_GLOVE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_DEKOI);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_TIMERG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CHARGEBOW);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_SHAKE_STRONG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_E_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_SBOX);

	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_SNIPER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_SHAKETRAP);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_TURRET);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_GATLING);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_MAN_GUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_TRANSIBER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_H_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_DRINK);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_STUNGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_LASER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_PISTOL2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_MANHAC);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_RPG2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_INVISIBLE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_GLOVE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_DEKOI);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_TIMERG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_CHARGEBOW);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_SHAKE_STRONG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_RUN_E_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_RUN_SBOX);

	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_CROUCH_SNIPER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_CROUCH_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_CROUCH_SHAKETRAP);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_CROUCH_TURRET);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_CROUCH_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_CROUCH_GATLING);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_CROUCH_MAN_GUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_TRANSIBER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_IDLE_CROUCH_H_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_DRINK);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_STUNGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_CROUCH_LASER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_PISTOL2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_MANHAC);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_RPG2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_INVISIBLE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_GLOVE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_DEKOI);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_TIMERG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_CHARGEBOW);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_IDLE_CROUCH_SHAKE_STRONG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_CROUCH_E_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_CROUCH_SBOX);

	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_SNIPER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_SHAKETRAP);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_TURRET);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_GATLING);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_MAN_GUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_TRANSIBER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_H_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_DRINK);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_STUNGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_LASER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_PISTOL2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_MANHAC);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_RPG2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_INVISIBLE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_GLOVE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_DEKOI);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_TIMERG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_CHARGEBOW);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_WALK_CROUCH_SHAKE_STRONG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_E_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_WALK_CROUCH_SBOX);

	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_SNIPER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_SHAKETRAP);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_TURRET);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK01_GATLING);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_H_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_DRINK);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_STUNGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_LASER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_PISTOL2_R);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_PISTOL2_L);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_MANHAC);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_RPG2_R);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_RPG2_L);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_RPG2_RL);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_INVISIBLE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_GLOVE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_DEKOI);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_TIMERG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_CHARGEBOW);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RANGE_ATTACK_SHAKE_STRONG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_E_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RANGE_ATTACK_SBOX);

	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_SNIPER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_SHAKETRAP);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_TURRET);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_GATLING);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_MAN_GUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_TRANSIBER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_H_SHIELD);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_DRINK);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_STUNGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_LASER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_PISTOL2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_MANHAC);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_RPG2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_INVISIBLE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_GLOVE);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_DEKOI);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_TIMERG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_CHARGEBOW);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_JUMP_SHAKE_STRONG);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_E_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_JUMP_SBOX);

	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RELOAD_SNIPER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RELOAD_INJECTION);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RELOAD_DRINK);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RELOAD_LASER);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RELOAD_PISTOL2);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RELOAD_MANHAC);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RELOAD_DEKOI);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_GESTURE_RELOAD_CHARGEBOW);
	REGISTER_SHARED_ACTIVITY(ACT_HL2AC_GESTURE_RELOAD_E_INJECTION);
