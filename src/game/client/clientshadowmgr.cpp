...
static ConVar r_worldlight_castshadows("r_worldlight_castshadows", "1", FCVAR_ARCHIVE, "Allow world lights to cast shadows", true, 0, true, 1, WorldLightCastShadowCallback);
...
ConVar r_maxshadowmaps("r_maxshadowmaps", "10");
...
bool CClientShadowMgr::Init()
{
	...
	m_nMaxDepthTextureShadows = r_maxshadowmaps.GetInt();
