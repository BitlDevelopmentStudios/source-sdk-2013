...
static ConVar mat_slopescaledepthbias_shadowmap( "mat_slopescaledepthbias_shadowmap", "4", FCVAR_CLIENTDLL | FCVAR_ARCHIVE );
static ConVar mat_depthbias_shadowmap(	"mat_depthbias_shadowmap", "0.0001", FCVAR_CLIENTDLL | FCVAR_ARCHIVE  );
